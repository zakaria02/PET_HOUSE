...
/**
 * @package Plugin
 * @subpackage Templates_Source
 * @author Nazmul Ahsan <n.mukto@gmail.com>
 */
class Templates_Source extends \Elementor\TemplateLibrary\Source_Base {

	/**
	 * Template prefix
	 */
	protected $template_prefix = 'woolementor_';
	...
	public function get_title() {
		return __( 'Woolementor', 'woolementor' );
	}

	public function register_data() {}

	public function get_items( $args = array() ) {
		$url            = WOOLEMENTOR_LIB_URL . '/list';
	...
	public function get_item( $template_data ) {
		return array(
			...
			'isPro'           => false,//( 1 == $template_data['isPro'] ),
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		$url        = WOOLEMENTOR_LIB_URL . '/get/' . $filename;
		$response   = wp_remote_get( $url, [ 'timeout' => 60 ] );
		$body       = wp_remote_retrieve_body( $response );
		$body       = json_decode( $body, true );
